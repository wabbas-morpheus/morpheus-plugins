...
import com.morpheusdata.api.CatalogsController
...
class MorpheusHomeDashboardPlugin extends Plugin {
	...
	// 	Permission permission = new Permission('Catalogs Widget API', 'catalogs-api', [Permission.AccessType.none, Permission.AccessType.read, Permission.AccessType.full])
	// 	return [permission];
	// }
